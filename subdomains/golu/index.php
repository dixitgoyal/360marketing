<?php
	...
	$dom=$domain.".360marketing.in";
	
	$sql="select * from registered_domains where domain_names='$dom'";
	...
	if($result->num_rows)
	{
		...
		$sql1="select * from user where domain_name='$dom'";
		...
		if($result1)
		{
			...
			{
				$logo_name='360 Marketing';	
			}
			
			$sql="select * from slider where user_id='$user_id'";
			
			$result=$conn->query($sql);
			
			if(!$result->num_rows)
			{
				$sql="insert into slider(user_id,count) values('$user_id','3')";
				$conn->query($sql);
			}
...
<html>
	<head>
		<title><?php echo $domain.".360marketing.in"; ?></title>
	...
	<body> 
		...
		<div class="header-top">
			<div class="header-bottom">			
				<div class="logo">
					<h1><a href="index.html"><?php echo $logo_name; ?></a></h1>					
				</div>
				<!---->		 
				<div class="top-nav">
